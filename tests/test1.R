...
# DATA CLEANING  #
##################
DF <- read_excel("Datas/Copie de Copie de thèse.xlsx",
...
setwd("~/MEGA/ARTICLES/Packages/autostats")
source("R/reglog.R")
tbf <- reglog(DF,y="Récidive",min_multivariate=2)
tbf2 <- reglog(DF,y="Récidive",min_multivariate=2,method = "PS")
tbf3 <- reglog(DF,y="Récidive",min_multivariate=2,method = "forward")
tbf
tbf2
tbf3
